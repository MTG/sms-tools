...
class HpsModel_frame:
    ...
    def initUI(self):
        ...
        Label(self.parent, text=stocf_label).grid(row=22, column=0, sticky=W, padx=5, pady=(10,2))
        self.stocf = Entry(self.parent, justify=CENTER)
        self.stocf["width"] = 8
        self.stocf.grid(row=23, column=0, sticky=W, padx=10)
        ...
        self.compute.grid(row=24, column=0, padx=5, pady=(20,2), sticky=W)

        #BUTTON TO PLAY SINE OUTPUT
        output_label = "Sinusoidal:"
        Label(self.parent, text=output_label).grid(row=25, column=0, sticky=W, padx=5, pady=(20,15))
        self.output = Button(self.parent, text=">", command=lambda:self.play_out_sound('hpsModel_sines'), bg="gray30", fg="white")
        self.output.grid(row=25, column=0, padx=(75,5), pady=(20,15), sticky=W)

        #BUTTON TO PLAY STOCHASTIC OUTPUT
        output_label = "Stochastic:"
        Label(self.parent, text=output_label).grid(row=26, column=0, sticky=W, padx=5, pady=(5,15))
        self.output = Button(self.parent, text=">", command=lambda:self.play_out_sound('hpsModel_stochastic'), bg="gray30", fg="white")
        self.output.grid(row=26, column=0, padx=(75,5), pady=(5,15), sticky=W)

        #BUTTON TO PLAY OUTPUT
        output_label = "Output:"
        Label(self.parent, text=output_label).grid(row=27, column=0, sticky=W, padx=5, pady=(5,15))
        self.output = Button(self.parent, text=">", command=lambda:self.play_out_sound('hpsModel'), bg="gray30", fg="white")
        self.output.grid(row=27, column=0, padx=(75,5), pady=(5,15), sticky=W)
    ...
    def compute_model(self):
        ...
        try:
            ...
            hpsModel_example.main(self.filelocation.get(), self.w_type.get(), M, N, t, minSineDur, nH, minf0, maxf0, f0et, harmDevSlope, stocf)
