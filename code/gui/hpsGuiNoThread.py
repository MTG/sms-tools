...
class MainWindow(QDialog, smsGui.Ui_MainWindow):
  ...
  def __init__(self, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, parent = None):
    super(MainWindow, self).__init__(parent)
    self.setupUi(self)
    
  #   self.label.setText("<b>w: </b> %d, <b>N: </b> %d, <b>t: </b> %d<br>"
		# "<b>nH: </b> %d, <b>minf0: </b> %d, <b>maxf0: </b> %d<br>"
		# "<b>f0et: </b> %d, <b>maxhd: </b> %.2f, <b>stocf: </b> %.2f" %(w.size, N, t, nH, minf0, maxf0, f0et, maxhd, stocf))

    self.nextButton.clicked.connect(functools.partial(self.playButtonClicked, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, True, 1, True))
    self.playButton.clicked.connect(functools.partial(self.playButtonClicked, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, True, 1))
    self.rewindButton.clicked.connect(functools.partial(self.playButtonClicked, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, True, 100))
    self.doubleRewindButton.clicked.connect(functools.partial(self.playButtonClicked, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, True, 500))
    self.endButton.clicked.connect(functools.partial(self.playButtonClicked, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, False, 0))
  ...
  def playButtonClicked(self, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, plot, step, process = False):
  ...
  def hps(self, x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf, plot, step, process = False) :
    ...
    #-----synthesis-----
      ...
      if plot and (n_frame%step == 0 or (pin+H) > pend):
...
if __name__ == '__main__':
  ...
  maxhd = 0.2
  stocf = 0.5
  form = MainWindow(x, fs, w, N, t, nH, minf0, maxf0, f0et, maxhd, stocf)
  form.show()
  app.exec_()