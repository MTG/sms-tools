...
class HpsMorph_frame:
	...
	def initUI(self):
		...
		self.transf_output = Button(self.parent, text=">", command=lambda:self.play_out_sound('hpsMorph'), bg="gray30", fg="white")
	...
	def play_out_sound(self, extension):
		...
		filename = 'output_sounds/' + os.path.basename(self.inputFile1)[:-4] + '_' + extension + '.wav'
