# function call to the transformation function of relevance to the stft
...
def main (inputFile1='../../sounds/ocean.wav', inputFile2='../../sounds/speech-male.wav', window1='hamming',  window2='hamming', 
	...
	# smoothf: smoothing factor to be applyed to sound 2
	...
	# write output sound
	outputFile = 'output_sounds/' + os.path.basename(inputFile1)[:-4] + '_stftTransformation.wav'
	...
	plt.title('input sound: x')
		...
		# plot magnitude spectrogram of input sound 
	plt.subplot(4,1,2)
	...
	# plot magnitude spectrogram of output sound 
	plt.subplot(4,1,3)
