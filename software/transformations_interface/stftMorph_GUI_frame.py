...
class StftMorph_frame:
	...
	def initUI(self):
		...
		preview1 = Button(self.parent, text=">", command=self.preview_sound1, bg="gray30", fg="white")
		preview1.grid(row=0, column=0, sticky=W, padx=(375,6), pady=(10,2))
		
		## INPUT FILE 2
		choose2_label = "inputFile2:"
		Label(self.parent, text=choose2_label).grid(row=1, column=0, sticky=W, padx=5, pady=(10,2))
 
		#TEXTBOX TO PRINT PATH OF THE SOUND FILE
		self.filelocation2 = Entry(self.parent)
		self.filelocation2.focus_set()
		self.filelocation2["width"] = 30
		self.filelocation2.grid(row=1,column=0, sticky=W, padx=(75, 5), pady=(10,2))
		...
		open_file2.grid(row=1, column=0, sticky=W, padx=(330, 6), pady=(10,2)) #put it beside the filelocation textbox
 
		#BUTTON TO PREVIEW SOUND FILE 2
		preview2 = Button(self.parent, text=">", command=self.preview_sound2, bg="gray30", fg="white")
		preview2.grid(row=1, column=0, sticky=W, padx=(375,6), pady=(10,2))
		...
		Label(self.parent, text=wtype1_label).grid(row=2, column=0, sticky=W, padx=5, pady=(10,2))
		...
		window1_option.grid(row=2, column=0, sticky=W, padx=(68,5), pady=(10,2))

		#WINDOW SIZE SOUND 1
		M1_label = "M1:"
		Label(self.parent, text=M1_label).grid(row=2, column=0, sticky=W, padx=(180, 5), pady=(10,2))
		self.M1 = Entry(self.parent, justify=CENTER)
		self.M1["width"] = 5
		self.M1.grid(row=2,column=0, sticky=W, padx=(208,5), pady=(10,2))
		self.M1.delete(0, END)
		self.M1.insert(0, "1024")

		#FFT SIZE SOUND 1
		N1_label = "N1:"
		Label(self.parent, text=N1_label).grid(row=2, column=0, sticky=W, padx=(265, 5), pady=(10,2))
		self.N1 = Entry(self.parent, justify=CENTER)
		self.N1["width"] = 5
		self.N1.grid(row=2,column=0, sticky=W, padx=(290,5), pady=(10,2))
		self.N1.delete(0, END)
		self.N1.insert(0, "1024")

		#HOP SIZE SOUND 1
		H1_label = "H1:"
		Label(self.parent, text=H1_label).grid(row=2, column=0, sticky=W, padx=(343,5), pady=(10,2))
		self.H1 = Entry(self.parent, justify=CENTER)
		self.H1["width"] = 5
		self.H1.grid(row=2, column=0, sticky=W, padx=(370,5), pady=(10,2))
		...
		Label(self.parent, text=wtype2_label).grid(row=3, column=0, sticky=W, padx=5, pady=(10,2))
		...
		window2_option.grid(row=3, column=0, sticky=W, padx=(68,5), pady=(10,2))

		#WINDOW SIZE SOUND 2
		M2_label = "M2:"
		Label(self.parent, text=M2_label).grid(row=3, column=0, sticky=W, padx=(180, 5), pady=(10,2))
		self.M2 = Entry(self.parent, justify=CENTER)
		self.M2["width"] = 5
		self.M2.grid(row=3,column=0, sticky=W, padx=(208,5), pady=(10,2))
		self.M2.delete(0, END)
		self.M2.insert(0, "1024")

		#FFT SIZE SOUND 2
		N2_label = "N2:"
		Label(self.parent, text=N2_label).grid(row=3, column=0, sticky=W, padx=(265, 5), pady=(10,2))
		self.N2 = Entry(self.parent, justify=CENTER)
		self.N2["width"] = 5
		self.N2.grid(row=3,column=0, sticky=W, padx=(290,5), pady=(10,2))
	...
	def preview_sound1(self):
		filename = self.filelocation1.get()
	...
	def preview_sound2(self):
		filename = self.filelocation2.get()
	...
	def play_out_sound(self, extension):
		...
		filename = 'output_sounds/' + os.path.basename(self.filelocation1.get())[:-4] + '_' + extension + '.wav'
