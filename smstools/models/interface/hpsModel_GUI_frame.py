...
class HpsModel_frame:
    ...
    def initUI(self):
        ...
        Label(self.parent, text=harmDevSlope_label).grid(
            row=12, column=0, sticky=W, padx=5, pady=(10, 2)
        )
        ...
        Label(self.parent, text=stocf_label).grid(
            row=13, column=0, sticky=W, padx=5, pady=(10, 2)
        )
        ...
        Label(self.parent, text=output_label).grid(
            row=15, column=0, sticky=W, padx=5, pady=(10, 0)
        )
        self.output = Button(
            self.parent,
            text=">",
        ...
        Label(self.parent, text=output_label).grid(
            row=16, column=0, sticky=W, padx=5, pady=(5, 0)
        )
        self.output = Button(
            self.parent,
            text=">",
        ...
        output_label = "Output:"
        Label(self.parent, text=output_label).grid(
            row=17, column=0, sticky=W, padx=5, pady=(5, 15)
        )
        self.output = Button(
            self.parent,
            text=">",
