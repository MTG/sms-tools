...
class HpsMorph_frame:
    ...
    def initUI(self):
        ...
        t1_label = "t1:"
        Label(self.parent, text=t1_label).grid(
        ...
        Label(self.parent, text=minSineDur1_label).grid(
            row=2, column=0, sticky=W, padx=(5, 5), pady=(4, 2)
        )
        ...
        minf01_label = "minf01:"
        Label(self.parent, text=minf01_label).grid(
            row=2, column=0, sticky=W, padx=(157, 5), pady=(4, 2)
        )
        ...
        maxf01_label = "maxf01:"
        Label(self.parent, text=maxf01_label).grid(
            row=2, column=0, sticky=W, padx=(270, 5), pady=(4, 2)
        )
        ...
        f0et1_label = "f0et1:"
        Label(self.parent, text=f0et1_label).grid(
            row=3, column=0, sticky=W, padx=5, pady=(4, 2)
        )
        ...
        Label(self.parent, text=harmDevSlope1_label).grid(
            row=3, column=0, sticky=W, padx=(108, 5), pady=(4, 2)
        )
        ...
        open_file2.grid(
            row=5, column=0, sticky=W, padx=(330, 6), pady=(2, 2)
        )  # put it beside the filelocation textbox
        ...
        Label(self.parent, text=wtype2_label).grid(
            row=6, column=0, sticky=W, padx=5, pady=(4, 2)
        )
        ...
        Label(self.parent, text=M2_label).grid(
            row=6, column=0, sticky=W, padx=(180, 5), pady=(4, 2)
        )
        ...
        Label(self.parent, text=N2_label).grid(
            row=6, column=0, sticky=W, padx=(265, 5), pady=(4, 2)
        )
        ...
        t2_label = "t2:"
        Label(self.parent, text=t2_label).grid(
            row=6, column=0, sticky=W, padx=(343, 5), pady=(4, 2)
        )
        ...
        Label(self.parent, text=minSineDur2_label).grid(
            row=7, column=0, sticky=W, padx=(5, 5), pady=(4, 2)
        )
        ...
        minf02_label = "minf02:"
        Label(self.parent, text=minf02_label).grid(
            row=7, column=0, sticky=W, padx=(157, 5), pady=(4, 2)
        )
        ...
        maxf02_label = "maxf02:"
        Label(self.parent, text=maxf02_label).grid(
            row=7, column=0, sticky=W, padx=(270, 5), pady=(4, 2)
        )
        ...
        f0et2_label = "f0et2:"
        Label(self.parent, text=f0et2_label).grid(
            row=8, column=0, sticky=W, padx=5, pady=(4, 2)
        )
        ...
        Label(self.parent, text=harmDevSlope2_label).grid(
            row=8, column=0, sticky=W, padx=(108, 5), pady=(4, 2)
        )
        ...
        Label(self.parent, text=nH_label).grid(
            row=10, column=0, sticky=W, padx=(5, 5), pady=(2, 2)
        )
        ...
        Label(self.parent, text=stocf_label).grid(
            row=10, column=0, sticky=W, padx=(98, 5), pady=(2, 2)
        )
        ...
        # SEPARATION LINE
        Frame(self.parent, height=1, width=50, bg="black").grid(
            row=11, pady=5, sticky=W + E
        )
        ###

        #
        hfreqIntp_label = (
            "harmonic frequencies interpolation factors, 0 to 1 (time,value pairs)"
        )
        Label(self.parent, text=hfreqIntp_label).grid(
            row=12, column=0, sticky=W, padx=5, pady=(2, 2)
        )
        ...
        #
        hmagIntp_label = (
            "harmonic magnitudes interpolation factors, 0 to 1 (time,value pairs)"
        )
        Label(self.parent, text=hmagIntp_label).grid(
            row=14, column=0, sticky=W, padx=5, pady=(5, 2)
        )
        ...
        #
        stocIntp_label = (
            "stochastic component interpolation factors, 0 to 1 (time,value pairs)"
        )
        Label(self.parent, text=stocIntp_label).grid(
            row=16, column=0, sticky=W, padx=5, pady=(5, 2)
        )
        ...
        self.transf_output = Button(
            ...
            command=lambda: UF.wavplay(
                "output_sounds/"
                + os.path.basename(self.filelocation1.get())[:-4]
                + "_hpsMorph.wav"
            ),
        )
        self.transf_output.grid(
            row=18, column=0, padx=(165, 5), pady=(10, 15), sticky=W
        )
